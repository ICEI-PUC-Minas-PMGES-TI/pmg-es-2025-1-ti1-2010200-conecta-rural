document.addEventListener('DOMContentLoaded', () => {
    ...
    if (editId) {
        ...
        if (cursoParaEditar) {
            ...
            document.getElementById('video').value = cursoParaEditar.video || '';
            document.getElementById('imagemUrl').value = cursoParaEditar.imagem || ''; // Preenche o campo com a URL existente
    ...
    formularioCurso.addEventListener('submit', function(e) {
        ...
        const curso = {
            ...
            imagem: document.getElementById('imagemUrl').value, // Pega a URL da imagem
